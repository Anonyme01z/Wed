export function initStory() {
  ...
  storyRoot.innerHTML = `
    ...
    <div class="story-card single-view">
        ...
        As fate would have it, a short while later, during the elections, she was posted to my neighborhood to vote. When she handed me her voter's card, I couldn't resist checking her age — just to be sure I was older. That little confirmation gave my heart the courage it needed.<br><br>
